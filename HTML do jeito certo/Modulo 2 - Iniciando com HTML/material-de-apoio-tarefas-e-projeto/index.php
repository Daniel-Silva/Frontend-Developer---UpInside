...
<html lang="pt-br">
    <head>
        <meta charset="UTF-8">
        <meta name="mit" content="2017-11-30T10:03:00-02:00+163380">
        <title>Curso de HTML5 - UpInside Treinamentos</title>
        <meta name="description" content="Está página web está sendo cosntruída no curso de HTML5 da UpInside Treinamentos!"/>
    ...
    <body>
        ...
        <main class="container">
                ...
                <article class="destaque container">
                    <div class="content">
                        ...
                        <div class="destaque_video">
                            <div class="ratio">
                                <iframe class="media" src="https://www.youtube.com/embed/TYXE-legZMU?list=PLi_gvjv-JgXq-SVk-gyVEa0r1WANGtZKn&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>
                            </div>
                        </div>
                        <div class="clear"></div>
                    </div>
            ...
            <section class="container curso">
                ...
                <footer class="container cursos_footer">
                    <div class="content">
                        <img title="Confira o curso completo HTML5 do Jeito Certo!" alt="[Confira o curso completo HTML5 do Jeito Certo!]" src="img/05.png"/>   
                        <h1>Curso HTML5 do Jeito Certo!</h1>
                        <p>Aprenda a Utilizar Todo o Poder do HTML5 Semântico Somado a Avançadas Técnicas de SEO para Criar Sites Altamente Lucrativos e Que Geram Resultados Rápidos e Eficientes!</p>
                        <a class="btn" target="_blank" title="Conheça o curso HTML5 do Jeito Certo!" href="http://www.upinside.com.br/oferta/html5-do-jeito-certo/">Conhecer Agora!</a>
                        <div class="clear"></div>
                    </div>
                </footer>
            ...
            <section class="container videoaulas">
                <div class="content">
                    <header class="big_title">
                        ...
                        <p class="tagline">confira aulgumas aulas do curso de HTML5!</p>
                    </header>
                ...
                <div class="ftcontent">
                    ...
                    <nav>
                        ...
                        <ul class="main_footer_social">
                            ...
                            <li>|</li>
                            <li><a target="_blank" title="UpInside Treinamentos No YouTube" href="//www.youtube.com/c/RobsonVLeite">YouTube</a></li>
                        </ul>
                    </nav>
                    <div class="clear"></div>
                </div>
        ...
        <script>
            (function (d, s, id) {
                ...
                js.id = id;
                js.src = "//connect.facebook.net/pt_BR/sdk.js#xfbml=1&version=v2.4&appId=626590460695980";
